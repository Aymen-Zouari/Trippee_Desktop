...
public class IdentifierCompteController implements Initializable {
    ...
    private void EnvoyerToken(MouseEvent event) {
        ...
        try {
            List<Client> users = clientCRUD.getClientByEmail(email);
            ObservableList<Client> observableUsers = FXCollections.observableArrayList(users);
    ...
    private static Credential getCredentials(final NetHttpTransport httpTransport, GsonFactory jsonFactory)
        ...
        System.out.println();
        gm.add(GMAIL_SEND);
        String json = "{\"installed\":{\"client_id\":\"500444830183-csr1sv2hd6clvc3sr24tls9dmkq3en18.apps.googleusercontent.com\",\"project_id\":\"high-transit-379208\",\"auth_uri\":\"https://accounts.google.com/o/oauth2/auth\",\"token_uri\":\"https://oauth2.googleapis.com/token\",\"auth_provider_x509_cert_url\":\"https://www.googleapis.com/oauth2/v1/certs\",\"client_secret\":\"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\",\"redirect_uris\":[\"http://localhost\"]}}";
